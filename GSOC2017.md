...
Wyliodryn STUDIO has an experiment version that allows users to program an OpenMote (http://www.openmote.com/) that is attached to a board (Raspberry Pi only at this moment). This experimental version supports only RIOT-OS (https://riot-os.org/).
...
### Mentors
* [Alexandru Vochescu](https://github.com/valexandru)
* [Pedro Henrique Gomes](https://github.com/pedrohenriquegomes)
* [Jason Tran](https://github.com/jasonatran)
