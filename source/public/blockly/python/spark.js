...
Blockly.Python.spark_read = function()
{
  ...
  {
    // var params= Blockly.Python.variableDB_.getDistinctName(
    //     'params', Blockly.Generator.NAME_TYPE);
    // var response = Blockly.Python.variableDB_.getDistinctName(
    //     'response', Blockly.Generator.NAME_TYPE);
...
Blockly.Python['spark_init'] = function(block) {
  ...
  //       'sparkId', Blockly.Generator.NAME_TYPE);
  // Blockly.Python.sparkId = id;
  // var token = Blockly.Python.variableDB_.getDistinctName(
  //       'sparkToken', Blockly.Generator.NAME_TYPE);
  // Blockly.Python.sparkToken = token;
...
Blockly.Python['spark_digitalread'] = function(block) {
  // var value_id = Blockly.Python.valueToCode(block, 'id', Blockly.Python.ORDER_ATOMIC);
  // var value_token = Blockly.Python.valueToCode(block, 'token', Blockly.Python.ORDER_ATOMIC);
  var value_pin = block.getFieldValue("pin");//Blockly.Python.valueToCode(block, 'pin', Blockly.Python.ORDER_ATOMIC);
