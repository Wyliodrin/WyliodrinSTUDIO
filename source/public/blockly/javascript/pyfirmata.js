...
{
  if(!Blockly.JavaScript.definitions_['firmata_pin_mode'])
  {
    Blockly.JavaScript.definitions_['firmata_pin_mode'] = 
...
Blockly.JavaScript['firmata_digitalwrite'] = function(block) {
  ...
  // TODO: Assemble JavaScript into code variable.
  var code = 'firmata.pinMode ('+value_digitalpin',1);\n'+
              'firmata.digitalWrite ('+value_digitalpin+', '+dropdown_value+');\n';
  return code;
};
