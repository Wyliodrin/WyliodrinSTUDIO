...
Blockly.Python.brickpi = function ()
{
    if (!Blockly.Python.definitions_['import_brickpi'])
    {
        Blockly.Python.definitions_['import_brickpi'] = 'from BrickPi import *\nBrickPiSetup()\n';
    }
}

Blockly.Python.brickpi_sensors = function ()
{
...
Blockly.Python.enable_motor = function (explicit, motor)
{
...
Blockly.Python.set_sensor = function (port, type)
{
...
Blockly.Python.brickpi_motor_all_stop= function() {
...
Blockly.Python.brickpi_motor_get_encoder= function() {
...
Blockly.Python.brickpi_sensor_new_val= function() {
    var port= this.getTitleValue('port');
    var code= 'self.sensorStatus["'+port+'"]';
    return [code, Blockly.Python.ORDER_ATOMIC];
}

Blockly.Python.brickpi_led_set= function() {
  var value_led1;
  var value_led2;
...
Blockly.Python.brickpi_update= function() {
  var code= 'BrickPiUpdateValues()\n';
  return code;
};

Blockly.Python.brickpi_startup= function() {
  var code= 'BrickPiSetupSensors()\n';
  return code;
};

Blockly.Python.brickpi_sensor_touch=function() {
...
Blockly.Python.brickpi_sensor_light=function() {
    var b=this.getTitleValue("port");;
...
Blockly.Python.brickpi_sensor_ultrasonic=function() {
    var b=this.getTitleValue("port");;
